...
/**
 * A function to calculate the best trajectory to shoot a note to the speaker.
 *
 * @param x_meter The X position in meters.
 * @param y_meter The Y position in meters.
 * @param vel_x The X velocity.
 * @param vel_y The Y velocity.
 *
 * @return An array with the angular velocity, yaw and pitch to shoot the note at.
 */
