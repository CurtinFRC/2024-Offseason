...
public class Intake extends SubsystemBase {
  ...
  public Intake(int beamBreakChannel, CANSparkMax motor) {
    ...
    m_beamBreakSensor =
        new DigitalInput(beamBreakChannel); // Initialize DigitalInput for beam break sensor
  }
  ...
  public Command spinUntilBeamBreak(double speed) {
    return achieveSpeed(speed).until(this::isBeamBroken).andThen(() -> m_motor.stopMotor(), this);
  }
